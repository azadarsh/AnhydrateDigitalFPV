...
#define PROCESSES_FLAGS_BALANCE_INTERRUPTS_CORES ((u32)(((u32)0x01)<<1))
#define PROCESSES_FLAGS_ENABLE_PRIORITIES_ADJUSTMENTS ((u32)(((u32)0x01)<<2))
#define PROCESSES_FLAGS_ENABLE_AFFINITY_CORES ((u32)(((u32)0x01)<<3))
#define PROCESSES_FLAGS_ENABLE_AFFINITY_CORES_VIDEO_CAPTURE ((u32)(((u32)0x01)<<4))
#define PROCESSES_FLAGS_ENABLE_AFFINITY_CORES_BALANCE_OIPC ((u32)(((u32)0x01)<<5))


#define TELEMETRY_FLAGS_FULL_BIDIRECTIONAL ((u32)(((u32)0x01)))
//Deprecated in 11.2 #define TELEMETRY_FLAGS_RXONLY ((u32)(((u32)0x01)<<1))
...
#define TELEMETRY_FLAGS_SEND_FULL_TELEMETRY_TO_CONTROLLER ((u32)(((u32)0x01)<<10))
#define TELEMETRY_FLAGS_SEND_FULL_TELEMETRY_TO_CONTROLLER_PLUGINS ((u32)(((u32)0x01)<<11))
...
#define MODEL_CHANGED_VIDEO_PARAMETERS 9 // New in 11.2
...
#define MODEL_CHANGED_OVERCLOCKING 20
...
#define MODEL_CHANGED_DEVELOPER_FLAGS 38
#define MODEL_CHANGED_CAMERA_CALIBRATION_FILE 39
...
// Used on uModelRuntimeStatusFlags:
#define MODEL_RUNTIME_STATUS_FLAG_IN_PIT_MODE ((u32)(((u32)0x01)))
#define MODEL_RUNTIME_STATUS_FLAG_IN_PIT_MODE_TEMPERATURE ((u32)(((u32)0x01)<<1))
#define MODEL_RUNTIME_STATUS_FLAG_IN_TX_AUTO_POWER_MODE ((u32)(((u32)0x01)<<2))
...
#define DEVELOPER_FLAGS_BIT_ENABLE_DEVELOPER_MODE ((u32)(((u32)0x01)<<3))
#define DEVELOPER_FLAGS_BIT_ENABLE_VIDEO_STREAM_TIMINGS ((u32)(((u32)0x01)<<4))
...
#define DEVELOPER_FLAGS_WIFI_GUARD_DELAY_MASK ((u32)(0x0000FF00))
#define DEVELOPER_FLAGS_WIFI_GUARD_DELAY_MASK_SHIFT 8
...
#define RELAY_MODE_PERMANENT_REMOTE (((u32)1)<<6)
...
// Radio interfaces flags
#define RADIO_INTERFACES_FLAGS_PIT_MODE_ENABLE ((u32)1)
#define RADIO_INTERFACES_FLAGS_PIT_MODE_ENABLE_MANUAL (((u32)1)<<1)
#define RADIO_INTERFACES_FLAGS_PIT_MODE_ENABLE_ARMDISARM (((u32)1)<<2)
