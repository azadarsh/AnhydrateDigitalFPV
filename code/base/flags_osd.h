...
#define OSD_FLAG2_SHOW_TX_POWER ((u32)(((u32)0x01)<<10))
...
//Deprecated in 11.2 #define OSD_FLAG2_SHOW_ADAPTIVE_VIDEO_GRAPH ((u32)(((u32)0x01)<<21))
...
#define OSD_FLAG2_SHOW_VIDEO_FRAMES_STATS ((u32)(((u32)0x01)<<28))
