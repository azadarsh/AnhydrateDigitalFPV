...
#define SHARED_MEM_RADIO_STATS "/SYSTEM_SHARED_MEM_Anhydrate_RADIO_STATS"
#define SHARED_MEM_RADIO_STATS_RX_HIST "/SYSTEM_SHARED_MEM_Anhydrate_RADIO_STATS_RX_HIST"
